...
\title{State of the Art of Agile Methodologies}

% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Ana Sousa}
\IEEEauthorblockA{Faculty of Engineering\\
University of Porto\\
Porto, Portugal\\
Email: ei11068@fe.up.pt}
\and
\IEEEauthorblockN{Augusto Silva}
\IEEEauthorblockA{Faculty of Engineering\\
University of Porto\\
Porto, Portugal\\
Email: augusto.cravo.silva@fe.up.pt}
\and
\IEEEauthorblockN{Gabriel Candal}
\IEEEauthorblockA{Faculty of Engineering\\
University of Porto\\
Porto, Portugal\\
Email: ei11066@fe.up.pt}
}
...
% in the abstract
\begin{abstract}
  There is a rising interest in searching alternative organizational,
project management and software development frameworks and methodologies to the
traditional top-down waterfall methods.
  However, understanding which different alternatives there are so that decision makers can
pick the best fit for their organization, or team, can be a daunting task since the
information regarding the several methodologies is either scattered or too superficial.
  This is specially true when the particular charecteristics under comparison are how
software testing is viewed under the lens of a particular methodology.
  In this article, we attempt to patch this issue, by providing a reasonably detailed overview of the most
widely used agile methodologies, with a special focus on how do they accomodate
software testing in their workflows.
\end{abstract}
...
\end{figure}
\footnotetext{According to a Scrum Alliance study \cite{ScrumAlliance:Zd-iSY9G}. Multiple answers were allowed.}
...
\bibitem{openalloc}
 Chris Dannen. \emph{Inside GitHub's Super-Lean Management Strategy And How It Drives Innovation".}
 Fastcolabs, 2013. http://www.fastcompany.com/3020181/open-company/inside-githubs-super-lean-management-strategy-and-how-it-drives-innovation .
 Accessed 4-Nov 2015.

\bibitem{kanban_def}
  \emph{Kanban}. Dictionary.com, 2015. Accessed 4-Nov 2015.

\bibitem{kanban_orig}
  Taiichi Ohno.
  \emph{Toyota Production System - beyond large-scale production}.
  Productivity Press, 1988.

\bibitem{kanban_orig2}
 James P. Womack and Daniel T. Jones and Daniel Roos.
 \emph{The Machine That Changed the World}.
 1990.

\bibitem{kanban_orig3}
  Steven Spear and H. Kent Bowen.
  \emph{Decoding the DNA of the Toyota Production System}.
  Harvard Business Review, 1999.

\bibitem{kanban_fig}
 Pawel Brodzinski.
 \emph{Kanban: When It Is Hard to Map a Process to a Kanban Board}.
 2011.
 http://brodzinski.com/2011/08/map-process-to-kanban-board.html .
 Accessed 4-Nov 2015.

\bibitem{tps}
  Y. Sugimori and K. Kusunoki and F. Cho and S. Uchikawa
  \emph{Toyota production system and Kanban system Materialization of just-in-time and respectfor-human
system}.
 International Journal of Production Research, 1977.

\bibitem{tps2}
  Jeffrey K. Liker
  \emph{The Toyota Way: 14 Management Principles from the World's Greatest Manufacturer.}
  McGraw-Hill, 2004.

\bibitem{spotify}
 Henrik Kniberg.
 \emph{Spotify engineering culture}.
 Spotify Labs, 2014.
...
\bibliography{IEEEabrv,augusto.bib}
